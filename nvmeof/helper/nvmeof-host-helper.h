...
#ifndef NVMEOF_HOST_HELPER_H
#define NVMEOF_HOST_HELPER_H
 ...
 * on a set of nodes.
 */
class NVMeoFHostHelper
{
public:
  /**
   * Create an NVMeoFHostHelper to make it easier to work with BulkSendApplications
   *
   ...
   *        to.
   */
  NVMeoFHostHelper (std::string protocol, Address address);
