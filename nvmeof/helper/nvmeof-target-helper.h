 ...
 */
#ifndef NVMEOF_TARGET_HELPER_H
#define NVMEOF_TARGET_HELPER_H
 ...
 * on a set of nodes.
 */
class NVMeoFTargetHelper
{
public:
  /**
   * Create a NVMeoFTargetHelper to make it easier to work with PacketSinkApplications
   *
   ...
   *
   */
  NVMeoFTargetHelper (std::string protocol, Address address);
