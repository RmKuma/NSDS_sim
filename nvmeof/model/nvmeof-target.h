...
#ifndef NVMEOF_TARGET_APPLICATION_H
#define NVMEOF_TARGET_APPLICATION_H
 ...
 * \defgroup packetsink NVMeoFTargetApplication
 *
 * This application was written to complement OnOffApplication, but it
 * is more general so a NVMeoFTargetApplication name was selected.  Functionally it is
...
public:
  ...
  NVMeoFTargetApplication ();

  virtual ~NVMeoFTargetApplication ();
